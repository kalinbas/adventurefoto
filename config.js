game.config = {
    ...
    objects: {
        ...
        smallgirl: {
            name: 'Niña pequeña',
            see: 'Esta niña pequeña parece que te quiere decir algo.',
            talk: true,
        },
        semaphore_red: {
            name: 'Semaforo rojo',
    ...
    dialogs: {
        smallgirl: {
            sprite: 'smallgirl_dialog',
            checks: [
                { type: 'nodisplay', value: 'semaphore_red', result: 'smallgirl_thanks' }
            ],
            text: "Hola, me puedes ayudar a cruzar la calle?",
            answers: [
                { text: "Como te ayudo?", dialog: "smallgirl_explain" },
                { text: "No quiero" },
            ]
        },
        smallgirl_explain: {
            sprite: 'smallgirl_dialog',
            text: "No puedo cruzar porque los coches pasan muy rapidos.",
            answers: [
                { text: "Ok" },
            ]
        },
        smallgirl_thanks: {
            sprite: 'smallgirl_dialog',
            text: "Muchas gracias, me ayudaste mucho.",
            answers: [
                { text: "Adios, ve con cuidado" },
            ]
        },
        girl: {
            sprite: 'girl_dialog',
